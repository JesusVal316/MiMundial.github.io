...
const traducciones = {
    es: {
        ...
        'normal': '⬜ Normal',
        'foro-ayuda-titulo': '¿Cómo usar el Foro del Mundial 2026?',
'foro-paso1-titulo': 'Publica contenido',
'foro-paso1-desc': 'Haz clic en el botón grande PUBLICAR para crear una nueva publicación con título, descripción, imagen y hashtags.',
'foro-paso2-titulo': 'Espera aprobación',
'foro-paso2-desc': 'Todas las publicaciones pasan por revisión. Recibirás una notificación cuando sea aceptada o rechazada.',
'foro-paso3-titulo': 'Interactúa',
'foro-paso3-desc': 'Dale Me gusta, comenta o comparte las publicaciones que te gusten. ¡Sé parte de la comunidad!',
'foro-paso4-titulo': 'Filtra lo que te interesa',
'foro-paso4-desc': 'Usa el botón de filtro para ver solo publicaciones de #Mundial2026, #Argentina, #Messi, goles, etc.',
'foro-paso5-titulo': '¿Eres administrador?',
'foro-paso5-desc': 'Si iniciaste sesión como administrador, verás el botón ADMINISTRAR para aprobar o rechazar publicaciones pendientes.',
'foro-paso6-titulo': 'Añade nuevas categorías',
'foro-paso6-desc': 'Haz clic en el botón + (solo administradores) para crear nuevas secciones o hashtags personalizados.',
'foro-consejo': '¡Recuerda!',
'foro-consejo-texto': 'Este es un espacio para compartir pasión por el fútbol. Sé respetuoso, usa hashtags y disfruta del Mundial 2026 con la comunidad.',
    ...
    en: {
        ...
        'normal': '⬜ Normal',
        'foro-ayuda-titulo': 'How to use the 2026 World Cup Forum?',
'foro-paso1-titulo': 'Post content',
'foro-paso1-desc': 'Click the big PUBLISH button to create a new post with title, description, image and hashtags.',
'foro-paso2-titulo': 'Wait for approval',
'foro-paso2-desc': 'All posts go through review. You will receive a notification when approved or rejected.',
'foro-paso3-titulo': 'Interact',
'foro-paso3-desc': 'Like, comment or share the posts you like. Be part of the community!',
'foro-paso4-titulo': 'Filter what interests you',
'foro-paso4-desc': 'Use the filter button to see only posts about #WorldCup2026, #Argentina, #Messi, goals, etc.',
'foro-paso5-titulo': 'Are you an admin?',
'foro-paso5-desc': 'If you logged in as administrator, you will see the ADMIN button to approve or reject pending posts.',
'foro-paso6-titulo': 'Add new categories',
'foro-paso6-desc': 'Click the + button (admins only) to create new sections or custom hashtags.',
'foro-consejo': 'Remember!',
'foro-consejo-texto': 'This is a space to share passion for football. Be respectful, use hashtags and enjoy the 2026 World Cup with the community.',
    ...
    'entendido': 'Compris !',
        'foro-ayuda-titulo': 'Comment utiliser le Forum de la Coupe du Monde 2026 ?',
'foro-paso1-titulo': 'Publiez du contenu',
'foro-paso1-desc': 'Cliquez sur le gros bouton PUBLIER pour créer une nouvelle publication.',
'foro-paso2-titulo': 'Attendez l’approbation',
'foro-paso2-desc': 'Toutes les publications passent par une révision.',
'foro-paso3-titulo': 'Interagissez',
'foro-paso3-desc': 'Aimez, commentez ou partagez les publications que vous aimez.',
'foro-paso4-titulo': 'Filtrez ce qui vous intéresse',
'foro-paso4-desc': 'Utilisez le bouton filtre pour voir seulement #CoupeDuMonde2026, #Argentine, #Messi, etc.',
'foro-paso5-titulo': 'Êtes-vous administrateur ?',
'foro-paso5-desc': 'Si vous êtes connecté en tant qu’administrateur, vous verrez le bouton ADMINISTRER.',
'foro-paso6-titulo': 'Ajoutez de nouvelles catégories',
'foro-paso6-desc': 'Cliquez sur le bouton + (administrateurs uniquement) pour créer de nouvelles sections.',
'foro-consejo': 'Rappelez-vous !',
'foro-consejo-texto': 'C’est un espace pour partager la passion du football. Soyez respectueux et profitez de la Coupe du Monde 2026 !',
