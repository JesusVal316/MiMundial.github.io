...
'registro-ayuda-titulo': '¿Cómo registrarme en Mi Mundial?',
'reg-paso1-titulo': 'Completa todos los campos',
'reg-paso1-desc': 'Rellena tu nombre de usuario, correo, contraseña segura y datos personales.',
'reg-paso2-titulo': 'Elige tu país y rol',
'reg-paso2-desc': 'Selecciona tu país de origen y si quieres ser Usuario normal o Administrador.',
'reg-paso3-titulo': 'Sube tu foto de perfil (opcional)',
'reg-paso3-desc': 'Haz clic en "Foto de perfil" para añadir una imagen que te represente.',
'reg-paso4-titulo': 'Acepta los términos',
'reg-paso4-desc': 'Haz clic en "Términos de uso" para leerlos y luego presiona "Confirmar".',
'reg-paso5-titulo': '¡Listo! Ya puedes entrar',
'reg-paso5-desc': 'Te aparecerá un mensaje de éxito y podrás iniciar sesión con tu nueva cuenta.',
'reg-consejo': 'Consejo:',
'reg-consejo-texto': 'Usa una contraseña segura con letras, números y símbolos.',
    ...
    'restablecer': 'Reset',
    'registro-ayuda-titulo': 'How to Register on My World Cup?',
'reg-paso1-titulo': 'Fill in all fields',
'reg-paso1-desc': 'Enter your username, email, a strong password, and personal details.',
'reg-paso2-titulo': 'Choose your country and role',
'reg-paso2-desc': 'Select your country and whether you want to be a regular User or Administrator.',
'reg-paso3-titulo': 'Upload your profile picture (optional)',
'reg-paso3-desc': 'Click on "Profile picture" to add an image that represents you.',
'reg-paso4-titulo': 'Accept the terms',
'reg-paso4-desc': 'Click "Terms of use" to read them and then press "Confirm".',
'reg-paso5-titulo': 'Done! You can now log in',
'reg-paso5-desc': 'You’ll see a success message and can log in with your new account.',
'reg-consejo': 'Tip:',
'reg-consejo-texto': 'Use a strong password with letters, numbers, and symbols.',
    ...
    'restablecer': 'Réinitialiser',
        ...
        'registro-ayuda-titulo': 'Comment s’inscrire sur Ma Coupe du Monde ?',
    'reg-paso1-titulo': 'Remplissez tous les champs',
    'reg-paso1-desc': 'Saisissez votre nom d’utilisateur, votre e-mail, un mot de passe sécurisé et vos informations personnelles.',
    'reg-paso2-titulo': 'Choisissez votre pays et votre rôle',
    'reg-paso2-desc': 'Sélectionnez votre pays d’origine et indiquez si vous souhaitez être Utilisateur normal ou Administrateur.',
    'reg-paso3-titulo': 'Ajoutez votre photo de profil (facultatif)',
    'reg-paso3-desc': 'Cliquez sur « Photo de profil » pour télécharger une image qui vous représente.',
    'reg-paso4-titulo': 'Acceptez les conditions d’utilisation',
    'reg-paso4-desc': 'Cliquez sur « Conditions d’utilisation » pour les lire, puis appuyez sur « Confirmer ».',
    'reg-paso5-titulo': 'C’est terminé ! Vous pouvez vous connecter',
    'reg-paso5-desc': 'Un message de succès apparaîtra et vous pourrez vous connecter avec votre nouveau compte.',
    'reg-consejo': 'Astuce :',
    'reg-consejo-texto': 'Utilisez un mot de passe fort contenant des lettres, chiffres et symboles.',
