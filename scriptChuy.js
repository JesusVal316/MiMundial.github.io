...
const traducciones = {
    es: {
        ...
        'normal': '⬜ Normal',
        'historia-ayuda-titulo': '¿Cómo explorar la Historia de los Mundiales?',
'historia-paso1-titulo': 'Desplázate por los años',
'historia-paso1-desc': 'Usa las flechas ← → o haz clic directamente en cualquier año del carrusel para seleccionarlo.',
'historia-paso2-titulo': 'Descubre cada Mundial',
'historia-paso2-desc': 'Al seleccionar un año, verás: foto oficial, campeón, subcampeón, estadísticas completas, mejores jugadores y un dato curioso.',
'historia-paso3-titulo': '¿Eres administrador?',
'historia-paso3-desc': 'Si iniciaste sesión como administrador, verás los botones: Agregar Mundial, Editar Mundial y Eliminar Mundial.',
'historia-paso4-titulo': 'Agregar un nuevo Mundial',
'historia-paso4-desc': 'Haz clic en “Agregar Mundial”, completa el formulario (año, título, imagen y descripción) y se añadirá al carrusel al instante.',
'historia-paso5-titulo': 'Editar o eliminar',
'historia-paso5-desc': 'Usa los botones correspondientes. ¡Cuidado! Eliminar un Mundial es permanente.',
'historia-consejo': 'Consejo:',
'historia-consejo-texto': '¡Explora todos los Mundiales! Desde el primero en 1930 hasta el futuro 2026 con 48 equipos.',
    ...
    'restablecer': 'Restablecer',
        ...
        'noticia1-desc': 'Las sedes en México, EE.UU. y Canadá están listas para recibir a millones de aficionados.',
        'noticia2-title': 'Selecciones clasificadas: ¿Quiénes estarán?',
        'noticia2-desc': 'Las eliminatorias avanzan y ya conocemos a varios equipos que competirán en 2026.',
        'noticia3-title': 'Estadios emblemáticos para el Mundial',
        'noticia3-desc': 'El Estadio Azteca hará historia albergando su tercer Mundial.',
        'noticia-link': 'Leer más',
    ...
    'entendido': 'Got it!',
        'historia-ayuda-titulo': 'How to explore the World Cup History?',
'historia-paso1-titulo': 'Scroll through the years',
'historia-paso1-desc': 'Use the ← → arrows or click directly on any year in the carousel.',
'historia-paso2-titulo': 'Discover each World Cup',
'historia-paso2-desc': 'When you select a year, you’ll see: official photo, champion, runner-up, full stats, best players and a fun fact.',
'historia-paso3-titulo': 'Are you an admin?',
'historia-paso3-desc': 'If you logged in as administrator, you’ll see the buttons: Add World Cup, Edit and Delete.',
'historia-paso4-titulo': 'Add a new World Cup',
'historia-paso4-desc': 'Click “Add World Cup”, fill the form (year, title, image and description) and it will appear instantly.',
'historia-paso5-titulo': 'Edit or delete',
'historia-paso5-desc': 'Use the corresponding buttons. Warning: deleting a World Cup is permanent.',
'historia-consejo': 'Tip:',
'historia-consejo-texto': 'Explore every World Cup! From the first one in 1930 to the future 2026 with 48 teams.',
    ...
    'entendido': 'Compris !',
        ...
        'normal': '⬜ Normal',
        'historia-ayuda-titulo': 'Comment explorer l’Histoire des Coupes du Monde ?',
'historia-paso1-titulo': 'Faites défiler les années',
'historia-paso1-desc': 'Utilisez les flèches ← → ou cliquez directement sur une année dans le carrousel.',
'historia-paso2-titulo': 'Découvrez chaque Coupe du Monde',
'historia-paso2-desc': 'En sélectionnant une année, vous verrez : photo officielle, champion, finaliste, statistiques complètes, meilleurs joueurs et une anecdote.',
'historia-paso3-titulo': 'Êtes-vous administrateur ?',
'historia-paso3-desc': 'Si vous êtes connecté en tant qu’ administrateur, vous verrez les boutons : Ajouter Coupe du Monde, Modifier et Supprimer.',
'historia-paso4-titulo': 'Ajouter une nouvelle Coupe du Monde',
'historia-paso4-desc': 'Cliquez sur « Ajouter Coupe du Monde », remplissez le formulaire et elle apparaîtra instantanément.',
'historia-paso5-titulo': 'Modifier ou supprimer',
'historia-paso5-desc': 'Utilisez les boutons correspondants. Attention : supprimer une Coupe du Monde est définitif.',
'historia-consejo': 'Astuce :',
'historia-consejo-texto': 'Explorez toutes les Coupes du Monde ! De la première en 1930 jusqu’à 2026 avec 48 équipes.',
    ...
    'restablecer': 'Réinitialiser',
        ...
        'hero-title': 'Équipes Participantes',
        'noticias-title': 'Dernières Nouvelles',
        'noticia1-title': 'Préparatifs pour la Coupe du Monde 2026 en cours',
        'noticia1-desc': 'Les sites au Mexique, aux États-Unis et au Canada sont prêts à accueillir des millions de fans.',
        'noticia2-title': 'Équipes qualifiées : Qui sera là ?',
        'noticia2-desc': 'Les qualifications avancent, et nous connaissons déjà plusieurs équipes qui concourront en 2026.',
        'noticia3-title': 'Stades emblématiques pour la Coupe du Monde',
        'noticia3-desc': 'Le Stade Azteca entrera dans l\'histoire en accueillant sa troisième Coupe du Monde.',
